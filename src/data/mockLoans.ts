...
export const mockLoans: Loan[] = [
  ...
  { id: 9, borrower: 'L. Thomas', vehicle: '2019 Ford F-150', vehicleYear: 2019, vehicleType: 'Truck', balance: 21400, rate: 22.99, originalTerm: 60, seasoning: 4, dpd: 45, enpv: 10700, enpvPercent: 50.0, riskTier: 'High', confidence: 'Low', creditScore: 492, downPayment: 2500, state: 'GA', ltv: 148, paymentStatus: 'Pre-Default', riskFactors: ['Very high LTV (148%)', 'Low seasoning (4 months)', 'DPD at 45', 'Credit score < 500'], survivalData: generateSurvival('High') },
  ...
  { id: 16, borrower: 'G. Walker', vehicle: '2017 Nissan Altima', vehicleYear: 2017, vehicleType: 'Sedan', balance: 6800, rate: 28.99, originalTerm: 36, seasoning: 30, dpd: 60, enpv: 2720, enpvPercent: 40.0, riskTier: 'High', confidence: 'Low', creditScore: 488, downPayment: 500, state: 'FL', ltv: 155, paymentStatus: 'Pre-Default', riskFactors: ['Very high LTV (155%)', 'DPD at 60', 'Credit score < 500', 'Near end of term'], survivalData: generateSurvival('High') },
